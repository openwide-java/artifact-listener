 ...
 */
package fr.openwide.maven.artifact.notifier.web.application.auth.pac4j.openid.client;
...
import fr.openwide.maven.artifact.notifier.web.application.auth.pac4j.openid.profile.google.GoogleOpenIdAttributesDefinition;
...
public class GoogleOpenIdClient extends BaseOpenIdClient<GoogleOpenIdProfile> {
    ...
    protected GoogleOpenIdProfile createProfile(final AuthSuccess authSuccess) throws MessageException {
        ...
        if (authSuccess.hasExtension(AxMessage.OPENID_NS_AX)) {
            ...
            for (final String name : GoogleOpenIdProfile.googleOpenIdDefinition.getAllAttributes()) {
