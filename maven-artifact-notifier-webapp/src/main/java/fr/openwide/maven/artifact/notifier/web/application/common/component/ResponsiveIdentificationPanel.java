...
public class ResponsiveIdentificationPanel extends Panel {

	private static final long serialVersionUID = 6906215013109234446L;
	...
	public ResponsiveIdentificationPanel(String id) {
		...
		Form<Void> signInForm = new StatelessForm<Void>("responsiveSignInForm") {
