<#ftl strip_text=true>
<#if SUBJECT!false>Nouvelles versions - ${.now?date?iso_utc}</#if>
...
Si vous souhaitez ne plus recevoir de notifications par mail, vous pouvez vous désabonner à l'adresse suivante :
${unsubscribeUrl}
