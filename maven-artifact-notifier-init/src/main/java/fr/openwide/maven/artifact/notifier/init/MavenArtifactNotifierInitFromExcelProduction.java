...
public final class MavenArtifactNotifierInitFromExcelProduction {

	private static final Logger LOGGER = LoggerFactory.getLogger(MavenArtifactNotifierInitFromExcelProduction.class);
	...
	private MavenArtifactNotifierInitFromExcelProduction() {
	}
}
